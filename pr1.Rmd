...
runtimes <-  lapply(movieDfNumericRuntimes$Runtime, parseRuntime)
...
movieDfNumericRuntimes$Runtime[1]
...
unique(movieDfNumericRuntimes$Year)

runtimeOverYearsBoxPlot <- ggplot(movieDfNumericRuntimes, aes(Year, Runtime)) + geom_boxplot()
```
